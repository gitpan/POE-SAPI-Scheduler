# This Makefile is for the POE::SAPI::Scheduler extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/POE/SAPI/Scheduler.pm]
#     AUTHOR => q[Paul G Webster <paul@daemonrage.net>]
#     BUILD_REQUIRES => {  }
#     NAME => q[POE::SAPI::Scheduler]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/POE/SAPI/Scheduler.pm]
...
MAKE = make
FULLEXT = POE/SAPI/Scheduler
BASEEXT = Scheduler
PARENT_NAME = POE::SAPI
DLBASE = $(BASEEXT)
VERSION_FROM = lib/POE/SAPI/Scheduler.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/POE/SAPI/Scheduler.pm
...
TO_INST_PM = lib/POE/SAPI/Scheduler.pm

PM_TO_BLIB = lib/POE/SAPI/Scheduler.pm \
	blib/lib/POE/SAPI/Scheduler.pm
...
DISTNAME = POE-SAPI-Scheduler
DISTVNAME = POE-SAPI-Scheduler-0.03
...
manifypods : pure_all  \
	lib/POE/SAPI/Scheduler.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/POE/SAPI/Scheduler.pm $(INST_MAN3DIR)/POE::SAPI::Scheduler.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               POE-SAPI-Scheduler' >> META_new.yml
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/POE/SAPI/Scheduler.pm blib/lib/POE/SAPI/Scheduler.pm 
